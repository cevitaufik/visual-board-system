...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-list toggle-sidebar-btn" viewBox="0 0 16 16">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
            ...
            <li class="notification-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-exclamation-circle text-warning" viewBox="0 0 16 16">
            ...
            <div class="col-12">
              <div class="card recent-sales my-bg-element">
                ...
                <div class="filter my-text-white">
                  <a class="icon" href="#" data-bs-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots" viewBox="0 0 16 16">
