...
@section('main')
  ...
  <main class="container-fluid p-3">
    ...
    <div class="container-fluid" id="table">
      ...
      <form action="/flow-process/{{ $flow->id }}" method="POST">
        @method('PUT')
        @csrf
        ...
        <div class="row align-items-center">
          <div class="col-2 p-1 mb-3">
            ...
            <input name="flow[no_drawing]" type="text" class="form-control" id="dwg-number" value="{{ $flow->no_drawing }}">
          </div>
          ...
          @foreach ($processes as $subprocess)
            ...
            <div data-sp="{{ $loop->index }}" id="subprocess-{{ $loop->index }}" class="subprocess border-bottom">
              ...
              @foreach ($subprocess as $process)
                ...
                <div class="row py-2 op-number-row" data-op="{{ $process['op_number'] }}" id="row-{{ $process['op_number'] }}">
