  ...
  <main class="container-fluid p-3 mb-5">
    <form action="/order/{{ $order->shop_order }}" id="order-detail" method="POST">
          ...
          <div class="row p-2">
            ...
            <div class="col-md-6 my-2">
              ...
              @if (isset($order->tool->status))
                <span class="fw-bold"> {{ $order->tool->status }}</span>
              @else
                N/A
              @endif
            </div>
      ...
      <div class="row mb-3 p-3">
        <div class="col-lg-12 border border-white rounded p-2">
          ...
          @if ($order->flow_process)
            <div class="py-1 mb-2">
              ...
              {{-- tombol print work order --}}
              <span class="btn btn-success ms-2" onclick="printWorkOrder({{ $order->shop_order }})" data-bs-toggle="tooltip" data-bs-placement="top" title="Print work order">
              ...
              {{-- tombol print label --}}
              <span class="btn btn-success ms-2" onclick="printLabel({{ $order->shop_order }})" data-bs-toggle="tooltip" data-bs-placement="top" title="Print label">
