...
<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    {{-- shopmanager --}}
    <li class="nav-item">
      <a class="nav-link collapsed" data-bs-target="#shopmanager-nav" data-bs-toggle="collapse" href="#">
      ...
      <ul id="shopmanager-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
    ...
    {{-- ppic --}}
    <li class="nav-item">
      <a class="nav-link collapsed" data-bs-target="#ppic-nav" data-bs-toggle="collapse" href="#">
      ...
      <ul id="ppic-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a href="#" class="nav-link">
            <span>Menu 1</span>
          </a>
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" data-bs-target="#engineering-nav" data-bs-toggle="collapse" href="#">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-motherboard" viewBox="0 0 16 16">
          <path fill-rule="evenodd" d="M1 2a2 2 0 0 1 2-2h11a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-2H.5a.5.5 0 0 1-.5-.5v-1A.5.5 0 0 1 .5 9H1V8H.5a.5.5 0 0 1-.5-.5v-1A.5.5 0 0 1 .5 6H1V5H.5a.5.5 0 0 1-.5-.5v-2A.5.5 0 0 1 .5 2H1Zm1 11V2a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v11a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1Zm9.5-11a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5Zm2 0a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5Zm-10 8a.5.5 0 0 0 0 1h6a.5.5 0 0 0 0-1h-6Zm0 2a.5.5 0 0 0 0 1h6a.5.5 0 0 0 0-1h-6ZM5 3a1 1 0 0 0-1 1h-.5a.5.5 0 0 0 0 1H4v1h-.5a.5.5 0 0 0 0 1H4a1 1 0 0 0 1 1v.5a.5.5 0 0 0 1 0V8h1v.5a.5.5 0 0 0 1 0V8a1 1 0 0 0 1-1h.5a.5.5 0 0 0 0-1H9V5h.5a.5.5 0 0 0 0-1H9a1 1 0 0 0-1-1v-.5a.5.5 0 0 0-1 0V3H6v-.5a.5.5 0 0 0-1 0V3Zm0 3.5V4h3v3H5v-.5Zm6.5 4.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h2a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-2Z"/>
        </svg>
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="/user/{{ auth()->user()->username }}">
